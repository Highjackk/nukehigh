...
class OWL():
    ...
    async def start(self):
        ...
        async def askChoice():
            ...
            if choice.__eq__('1'):
                ...
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
                      "Thank you for using thid Spammer")
                exit()
            else:
                print('\n                                       ' + Fore.BLUE +
                      '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
    ...
    async def bioChanger(self, token, bio):
        ...
        tk = token[:25] + "*" * 34 if len(token) > 25 else "*" * len(token)

        randomProxy = ''
        if not self.proxyless:
            randomProxy = self.proxies[random.randint(0, len(self.proxies)-1)]

        async with ClientSession(headers=headers, timeout=ClientTimeout(total=10)) as session:
            try:
                async with session.patch("https://discord.com/api/v9/users/@me", json={"bio": bio}, proxy=randomProxy) as r:
                    if r.status == 200:
                        print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} Cambiata!\n' + Fore.RESET)
                    elif r.status == 400:
                        print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} คุณไม่สามารถเปลี่ยนประวัติของคุณได้\n' + Fore.RESET)
                    else:
                        text = await r.text()
                        if "Bisogna verificare il token" in text:
                            print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} ไม่ยืนยันและ rimosso!\n' + Fore.RESET)
                            if token in self.tokens:
                                self.tokens.remove(token)
                        elif "Non autorizzato" in text:
                            print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} Non valido e rimosso dalla lista!\n' + Fore.RESET)
                            if token in self.tokens:
                                self.tokens.remove(token)
                        else:
                            print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} Impossibile cambiare la bio riprova!\n' + Fore.RESET)
            except aiohttp.ClientError as e:
                print('\n' + ' ' * 39 + Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN + f'{tk} Error: {e}\n' + Fore.RESET)
    ...
    async def screen11(self):
        ...
        while self.checked == False:
            ...
            print(
                ...
                + Fore.BLUE + '[' + Fore.CYAN + '/' +
                Fore.BLUE + '] ' + Fore.CYAN +
                f'Token controllati dalla finanza. Validi = {len(self.checked)} ~ Total = {len(self.totalChecked)}' +
                Fore.RESET)
            print(
                '                                       '
                + Fore.BLUE + '[' + Fore.CYAN + '/' +
                Fore.BLUE + '] ' + Fore.CYAN +
                f'Vuoi separare quelli validi apparte? [Y/N]: ' +
                Fore.RESET, end='')
            resp = input()
            if resp.lower() == 'y':
                added = 0
                ...
                while added != len(self.checked):
                    ...
                    print(
                        ...
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'Salvati in token.txt' +
                        Fore.RESET)
                    print(
                        '                                       '
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'Vuoi ritornare indietro? [Y/N]: ' +
                        Fore.RESET, end='')
                    r = input()
                    if r.lower() == 'y':
                        self.checked = []
                ...
                while added != len(self.checked):
                    ...
                    print(
                        ...
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'Ripiazzati con nuovi token in token.txt' +
                        Fore.RESET)
                    print(
                        '                                       '
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
            ...
            async with session.get(
                ...
                if r.status == 200:
                    ...
                    print(
                        ...
                        + Fore.BLUE + '[' + Fore.CYAN + '/' +
                        Fore.BLUE + '] ' + Fore.CYAN +
                        f'{tk} impossibile fare il check!\n' +
                        Fore.RESET)
                else:
                    text = await r.text()
                    if "Ti serve verificare l'account" in text:
                        print(
                            '\n                                       '
                            + Fore.BLUE + '[' + Fore.CYAN + '/' +
                            Fore.BLUE + '] ' + Fore.CYAN +
                            f'{tk} e bloccato e rimosso dalla lista!\n'
                            + Fore.RESET)
                        if token in self.tokens:
                            self.tokens.remove(token)
                    elif "Unauthorized" in text:
                        print(
                            ...
                            + Fore.BLUE + '[' + Fore.CYAN + '/' +
                            Fore.BLUE + '] ' + Fore.CYAN +
                            f'{tk} e invalido ed e stato rimosso!\n'
                            + Fore.RESET)
                        if token in self.tokens:
                            self.tokens.remove(token)
                    else:
    ...
    async def screen12(self):
        ...
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'Donate: Per ora chiusi verranno aperti nella alpha 2.0')
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'Grazie del pensiero <3')
        print(" ")
        print(
            Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' + Fore.CYAN +
            'Info: Questo e un tool creato dai TAC e serve per spammare nei server e per dare fastidio alle persone'
        )
        print(" ")
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
              Fore.CYAN + 'Vuoi ritornare indietro? [Y/N] > ',
              end='')
        goBack = input()
        if goBack == '0':
            await self.start()
    ...
    def exit(self):
        print(Fore.BLUE + '[' + Fore.CYAN + '/' + Fore.BLUE + '] ' +
                  Fore.CYAN + "Grazie per averci scelto")
        exit()

    def sendText(self, screen='main'):
        print(Fore.CYAN, end='')
        print("TAC DEVELOPMENT")
        ...
        print((Fore.MAGENTA + '                            Developed by ' +
               Fore.BLUE + 'Tac Development | ' + Fore.MAGENTA + 'Alpha 1.0 | ' + Fore.MAGENTA + 'Sta arrivando Alpha 2.0' + Fore.BLUE +
               '' + Fore.RESET).center(self.center))
        print(' ')

class Auth():
    async def start(self):
        try:
            client_id = '905474277397106698'
        ...
        if alreadyPut == True:
            ...
            try:
                ...
                time.sleep(0.5)
                with open(f'{appdata}/owl Spammer/serial_number.txt', 'w') as f:
